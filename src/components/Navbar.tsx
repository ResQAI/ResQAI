...
export default function Nav() {
  ...
  return (
    <nav className="absolute z-10 w-full border-b px-5 border-black/5 lg:border-transparent">
      <div className="mx-auto px-6 md:px-12 xl:px-6">
        <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 md:gap-0 md:py-4">
          ...
          <div
            ...
            } w-full lg:flex lg:w-auto lg:items-center lg:bg-transparent lg:rounded-none rounded-xl  bg-blue-50  `}
          >
