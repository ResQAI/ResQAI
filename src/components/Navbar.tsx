export default function Nav() {
  return (
    <nav className="absolute z-10 w-full border-b px-5 border-black/5 lg:border-transparent astro-ES6RJE63">
      <div className="mx-auto px-6 md:px-12 xl:px-6">
        <div className="relative flex flex-wrap items-center justify-between py-3 md:gap-0 md:py-4 astro-ES6RJE63">
          <div className="relative z-20 flex w-full justify-between md:px-0 lg:w-max astro-ES6RJE63">
            ...
            >
              ...
              <svg
                ...
                className="looka-1j8o68f h-12"
              >
                <defs id="SvgjsDefs4692">
                  <linearGradient id="SvgjsLinearGradient4697">
                    <stop
                      id="SvgjsStop4698"
                      stop-color="#2d388a"
                      offset="0"
                ...
                <g
                  ...
                  fill="url(#SvgjsLinearGradient4697)"
                >
          ...
          >
            <div className="w-full text-gray-600 ddkktext-gray-200 lg:w-auto lg:pr-4 lg:pt-0 astro-ES6RJE63">
              ...
              >
                ...
                <li>
                  <a
                    href="/awareness"
                    className="text-black hover:text-primary block transition md:px-4"
                  >
                    Awareness
                  </a>
                </li>
                <li>
                  <a
                    href="/quiz"
                    className="flex text-black gap-2 transition hover:text-primary md:px-4"
                  >
                    Quiz
                  </a>
                </li>
            ...
            <div className="mt-12 lg:mt-0 astro-ES6RJE63">
              <a
                href="/login"
                className="relative flex h-9 w-full items-center justify-center px-4 inset-0 rounded-full bg-primary transition duration-300 hover:scale-105 active:duration-75 active:scale-95 sm:w-max astro-ES6RJE63"
              >
