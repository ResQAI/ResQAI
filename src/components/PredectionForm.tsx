...
//                 />
//                 <div
//                     className="relative min-h-screen flex items-center justify-center bg-center bg-slate-50 py-12 px-4 sm:px-6 lg:px-8 bg-slate-50 bg-no-repeat bg-cover relative items-center"
...
//                             <h2 className="font-semibold text-lg mr-auto">AI Prediction </h2>
...
const Prediction = () => {
  ...
  const handlePredict = (event: React.MouseEvent<HTMLButtonElement>): void => {
    // Simulated prediction logic for demonstration
    const disasterDetected = Math.random() < 0.5; // Randomly decide for demo
                  ...
                  {predictionResult && (
                    <div className="mt-5 text-center">
                      ...
                      {predictionResult.includes("Disaster") && (
                        ...
                        <button className="mt-4 bg-red-500 text-white px-5 flex py-2 rounded-lg justify-between font-medium hover:shadow-lg hover:bg-red-600">
                            <TriangleAlert/>Montior the disaster
                        </button>
                        </div>
                      )}
                    </div>
