...
const ResourceRequestManagement = () => {
  ...
  const renderFilterButtons = (type: keyof Filters, options: string[]) => {
                ...
                <div className="flex flex-col gap-2">
                  <div className="flex flex-col justify-center items-center mb-4">
                    ...
                    <div className="flex space-x-2 mt-2">
                      <span
                        className={`px-3 py-1 rounded-full text-center text-xs font-semibold ${getUrgencyStyles(
                          request.urgency
                        )}`}
                      >
                        {request.urgency}
                      ...
                      <span
                        className={`px-3 py-1 rounded-full text-center text-xs font-semibold ${getStatusStyles(
                          request.status
                        )}`}
                      >
                        {request.status}
