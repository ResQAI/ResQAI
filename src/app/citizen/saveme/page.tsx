...
const SaveMeForm:React.FC = () => {
  ...
  if (formSubmitted) {
    return (
      <div className="flex flex-col items-center justify-center p-6 rounded-lg shadow-lg bg-green-100 max-w-md mx-auto text-center">
  ...
  return (
    <div className="flex flex-col items-center justify-center p-6 rounded-lg shadow-xl bg-white max-w-md mx-auto mt-16">
